	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="examples" Type="Folder">
			<Item Name="Handler" Type="Folder">
				<Item Name="Error Log Handler Example.vi" Type="VI" URL="../../examples/Handler/Error Log Handler Example.vi"/>
			</Item>
			<Item Name="Logger" Type="Folder">
				<Item Name="Error Log Example.vi" Type="VI" URL="../../examples/Logger/Error Log Example.vi"/>
				<Item Name="Error Log(by Ref) Example.vi" Type="VI" URL="../../examples/Logger/Error Log(by Ref) Example.vi"/>
			</Item>
		</Item>
